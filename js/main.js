...
document.addEventListener("DOMContentLoaded", function() {
    const headers = [
        {text: "GovNexus: Your Future-Proof Web 3.0\nGovernment OS.", subtext: `Unleash Efficiency, Enhance Transparency: \nThe Next Generation of Digital Governments.`},
        {text: "Modern Governments at the Nexus of Trust,Transparency & Trade.", subtext: "Connect, Collaborate & Thrive In The New Era of Governance."},
        {text: "Streamline Operations, Boost Transparency - The Future is Here.", subtext: "Unify Your 'Whole-of-Government' & 'Whole-of-Economy' \nOn Our Next-Gen Blockchain."},
        {text: "Unlock Global Potential: Powerful \nTools for a Thriving Economy.", subtext: "Elevate Your Economic Global Rankings:\nDrive Growth & Empower Economic Reforms with Our Solution."}
    ];
